  ...
  (
    ...
    React.useEffect(() => {
        ...
        if (diff > 0) {
          ...
          if (addedLabels.length === 1) {
            announce(
              ...
              `${addedLabels[0]!} selected. ${selectedCount.toString()} of ${totalOptions.toString()} options selected.`
            );
          } else {
            announce(
              `${addedLabels.length.toString()} options selected. ${selectedCount.toString()} of ${totalOptions.toString()} total selected.`
            );
          }
        } else if (diff < 0) {
          announce(
            `Option removed. ${selectedCount.toString()} of ${totalOptions.toString()} options selected.`
          );
        }
      ...
      if (isPopoverOpen !== prevIsOpen.current) {
        if (isPopoverOpen) {
          announce(
            `Dropdown opened. ${totalOptions.toString()} options available. Use arrow keys to navigate.`
          );
        } else {
        ...
        <Popover
          ...
          <div id={selectedCountId} className="sr-only" aria-live="polite">
            {selectedValues.length === 0
              ? "No options selected"
              : `${selectedValues.length.toString()} option${
          ...
          <PopoverTrigger asChild>
            <Button
              ...
              aria-label={`Multi-select: ${selectedValues.length.toString()} of ${
                getAllOptions().length.toString()
                ...
                <div className="flex justify-between items-center w-full">
                  <div
                    ...
                    {selectedValues
                      ...
                      .map((value) => {
                        ...
                        const badgeStyle: React.CSSProperties = {
                          animationDuration: `${animation.toString()}s`,
                        ...
                        return (
                          <Badge
                            ...
                            style={{
                              ...badgeStyle,
                              animationDuration: `${
                                (animationConfig?.duration ?? animation).toString()
                              }s`,
                              animationDelay: `${(animationConfig?.delay ?? 0).toString()}s`,
                            }}>
                    ...
                    {selectedValues.length > responsiveSettings.maxCount && (
                      <Badge
                        ...
                        {`+ ${
                          (selectedValues.length - responsiveSettings.maxCount).toString()
                        } more`}
                        <XCircle
                          className={cn(
                  ...
                  <div className="flex items-center justify-between">
                    <div
                      ...
                      aria-label={`Clear all ${selectedValues.length.toString()} selected options`}
          ...
          <PopoverContent
            ...
            style={{
              animationDuration: `${(animationConfig?.duration ?? animation).toString()}s`,
              animationDelay: `${(animationConfig?.delay ?? 0).toString()}s`,
                    ...
                    <CommandItem
                      ...
                      <span>
                        ...
                        {getAllOptions().length > 20
                          ? ` - ${getAllOptions().length.toString()} options`
                          : ""}
                        )
                      </span>
                    </CommandItem>
          ...
          {animation > 0 && selectedValues.length > 0 && (
            <WandSparkles
              className={cn(
                "cursor-pointer my-2 text-foreground bg-background-darker w-3 h-3",
